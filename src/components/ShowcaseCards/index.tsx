...
const ShowcaseList: ShowcaseItem[] = [
  {
    ...
    srcPath: require('@site/static/img/v1/overview/projectgalaxy.png').default,
  ...
  {
    title: 'Light.so',
    srcPath: require('@site/static/img/v1/overview/light.jpg').default,
  ...
  {
    title: 'Grape.art',
    srcPath: require('@site/static/img/v1/overview/grape.png').default,
  ...
  {
    title: 'Hello World',
    srcPath: require('@site/static/img/v1/overview/helloworld.png').default,
  ...
  {
    title: 'Unipass',
    srcPath: require('@site/static/img/v1/overview/unipass.png').default,
  ...
  {
    title: 'Convo Space',
    srcPath: require('@site/static/img/v1/overview/convospace.png').default,
  ...
  {
    title: 'Bress',
    srcPath: require('@site/static/img/v1/overview/bress.png').default,
  ...
  {
    title: 'Etherloop',
    srcPath: require('@site/static/img/v1/overview/etherloop.jpg').default,
  ...
  {
    title: 'Reveal',
    srcPath: require('@site/static/img/v1/overview/reveal.png').default,
  ...
  {
    title: 'Treasureland',
    srcPath: require('@site/static/img/v1/overview/treasureland.png').default,
  ...
  {
    title: 'Metajam',
    srcPath: require('@site/static/img/v1/overview/metajam.png').default,
  ...
  {
    title: 'NFTscan',
    srcPath: require('@site/static/img/v1/overview/nftscan.png').default,
