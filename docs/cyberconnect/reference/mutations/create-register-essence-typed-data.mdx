...
#### `input` ([`CreateRegisterEssenceTypedDataInput`](/cyberconnect/reference/inputs/create-register-essence-typed-data-input))
...
#### [`CreateRegisterEssenceTypedDataResult`](/cyberconnect/reference/objects/create-register-essence-typed-data-result) 
