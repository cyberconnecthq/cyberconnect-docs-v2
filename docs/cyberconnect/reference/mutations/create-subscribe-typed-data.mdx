...
#### `input` ([`CreateSubscribeTypedDataInput`](/cyberconnect/reference/inputs/create-subscribe-typed-data-input))
...
#### [`CreateSubscribeTypedDataResult`](/cyberconnect/reference/objects/create-subscribe-typed-data-result) 
