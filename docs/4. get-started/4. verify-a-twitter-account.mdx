...
That's it! You've implemented a simple social verifier in your application. For more advanced features, learn more about the [CyberConnect Social Verifier](/cyberconnect-sdk/connect-with-social-verifier/).
