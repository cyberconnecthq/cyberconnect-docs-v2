...
Now our focus will turn on creating a [connections](/concepts/connection/) and for that you'll need to create a `FollowButton` component that will handle the logic for that:
...
<iframe
    src="https://codesandbox.io/embed/create-a-connection-fvecwy?codemirror=1&fontsize=14&hidenavigation=0&theme=dark&runonclick=1&view=split"
    title="create-a-connection"
