...
[Install the CyberConnect SDK](/get-started/quick-setup/) before starting this section.
...
Your `followButton` component is completed! Now, your users can connect with each other on the Ethereum network. For more advanced features, learn more about the [CyberConnect SDK](/cyberconnect-sdk/connect-with-sdk/).
