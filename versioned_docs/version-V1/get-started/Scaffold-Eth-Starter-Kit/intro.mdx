...
To learn more about CyberConnect JS SDK, please read [Connect with JS SDK](https://docs.cyberconnect.me/V1/cyberconnect-sdk/connect-with-js-sdk/). We are using GraphQL to query our data, you can check this [link](https://graphql.org/) to learn more. [`graphql-request`](https://www.npmjs.com/package/graphql-request) is the simplest and the most lightweight GraphQL client. [`@babel/preset-env`](https://babeljs.io/docs/en/babel-preset-env) is a toolchain for converting ECMAScript 2015+ code into a backward-compatible version of JavaScript in the current and legend browsers and environments.
