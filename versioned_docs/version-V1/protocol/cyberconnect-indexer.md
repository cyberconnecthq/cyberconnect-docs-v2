...
We introduce how to mutate (follow and unfollow) a [connection](/concepts/connection/) status between addresses in [Connect with SDK](/V1/cyberconnect-sdk/connect-with-js-sdk/) and [Connect with Follow Button](/cyberconnect-sdk/connect-with-follow-button/) sections. In this section, we will guide you how to query connection data and get potential relationship [recommendations](/concepts/recommend/) from CyberConnect Indexer.
