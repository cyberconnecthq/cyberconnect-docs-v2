...
You can find the step-by-step instructions on how to set up the GraphQL client in your application and how to write a ”get NFT ownership” query in the [Read NFT's Ownership](/V1/get-started/read-nft-ownership) section.
...
This is an example of a query to fetch the owners for a certain NFT contract. You can also test out in the [Playground](/V1/cyberconnect-api/playground/):
...
This is an example of a query to fetch the owner of an NFT with the certain token id. You can also test out in the [Playground](/V1/cyberconnect-api/playground/):
