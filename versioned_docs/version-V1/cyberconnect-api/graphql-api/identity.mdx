...
You can find the step by step instructions on how to set up GraphQL client in your application and write a simple **Get Identity query** in the [Read Identity](/V1/get-started/read-identity/) section.
...
If you only need to query one address' ENS, you can run the query below in the [Playground](/V1/cyberconnect-api/playground/):
...
For detail, please check [Namespace](/V1/resources/terminology/namespace/) and [Pagination](/V1/resources/terminology/pagination/) page.

### Followers Example

You can use this snippet for address' follower list query directly in the [Playground](/V1/cyberconnect-api/playground/):
...
You can use this snippet to query an address's Twitter metadata in the [Playground](/V1/cyberconnect-api/playground/):
...
You can use this snippet to query an address's GitHub metadata in the [Playground](/V1/cyberconnect-api/playground/):
...
You can use this snippet to query an address’s unread notification count in the [Playground](/V1/cyberconnect-api/playground/):
...
You can use this snippet to query an address’s notification list in the [Playground](/V1/cyberconnect-api/playground/):
...
You can try Identity API in the [Playground](/V1/cyberconnect-api/playground/) page. Open the page, make sure the URL is correct, copy and paste the following query into the input.
