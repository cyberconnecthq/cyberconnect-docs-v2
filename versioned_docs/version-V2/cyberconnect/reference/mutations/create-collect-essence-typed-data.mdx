...
#### `input` ([`CreateCollectEssenceTypedDataInput`](/cyberconnect/reference/inputs/create-collect-essence-typed-data-input))
...
#### [`CreateCollectEssenceTypedDataResult`](/cyberconnect/reference/objects/create-collect-essence-typed-data-result) 
